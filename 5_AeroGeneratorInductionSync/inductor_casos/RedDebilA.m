...
%condiciones
wr=0.8; %velocidad angular del rotor
ids=-0.035; %ids de cada caso
iqs=0.343; %iqs de cada caso
idr=0.217; %idr de cada caso
iqr=0.367; %iqr de cada caso
a=-0.06; %Vds de cada caso
b=0.998; %Vqs de cada caso
c=-0.025; %Vdr de cada caso
d=0.206; %Vqr de cada caso
