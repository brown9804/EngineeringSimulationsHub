...
ids=-0.084; %ids de cada caso
iqs=0.649; %iqs de cada caso
idr=0.166; %idr de cada caso
iqr=0.693; %iqr de cada caso
a=-0.114; %Vds de cada caso
b=0.993; %Vqs de cada caso
c=0.025; %Vdr de cada caso
d=-0.097; %Vqr de cada caso
