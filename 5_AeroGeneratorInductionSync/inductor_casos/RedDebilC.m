...
%condiciones
wr=1.29; %velocidad angular del rotor
ids=-0.151; %ids de cada caso
iqs=0.959; %iqs de cada caso
idr=0.096; %idr de cada caso
iqr=1.024; %iqr de cada caso
a=-0.1169; %Vds de cada caso
b=0.986; %Vqs de cada caso
c=0.105; %Vdr de cada caso
d=-0.28; %Vqr de cada caso
